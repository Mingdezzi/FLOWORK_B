if (!window.SearchApp) {
    window.SearchApp = class SearchApp {
        constructor() {
            ...
            products.forEach(p => {
                const html = `
                    <li class="list-group-item p-0">
                        <a href="/product/${p.product_id}" class="product-item d-flex align-items-center text-decoration-none text-body">
